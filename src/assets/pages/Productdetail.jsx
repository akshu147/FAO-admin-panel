      ...
      <main>
        ...
        <div className="right" style={{ width: mywidth.secondwidth }}>
          ...
          <div className="deshboard-navigation flex">
            <Link to="/admin-panel/deshboard" className="text-decoration-none"><span>Home</span></Link> / <span>Product detail</span>
          </div>
          <div className="commen-div">
            ...
            <form action="">
              <div className="commencontent">
                ...
                <label className="py-3 m-0">Product Description</label>
                <textarea placeholder="Description"></textarea>
                <label className="py-3 m-0">Short description</label>
                <textarea placeholder="Short description"></textarea>
                <label className="py-3">Product image</label>
                <input type="file" placeholder="category image" />
                <label className="py-3">Image animation</label>
                <input type="file" placeholder="category image" />
                <label className="py-3">Product gallery</label>
                <input type="file" placeholder="category image" />
                <div className="row">
                  <div className="col">
                  ...
                  <div className="col">
                    <p className="pt-3">MRP</p>
                    <input type="text" placeholder="Product MRP" />
                  </div>
                </div>
                <p className="pt-3">Select parent category</p>
                <select id="list">
                  <option value="Parent category">--Select Parent Category</option>
                  <option value="Mans's">Man's</option>
                  <option value="Women's">Women's</option>
                </select>
                <p className="pt-3">--Select Product category</p>
                <select id="list">
                  <option value="Parent category">--Select Product Category</option>
                  <option value="Mans's">T-shirt</option>
                  <option value="Women's">Shirt</option>
                </select>
                <div className="row py-2">
                  <div className="col">
                  <p className="pt-3">Manage Stock</p>
                <select id="list">
                  <option value="Parent category">--Select Stock--</option>
                  <option value="Mans's">In stock</option>
                  <option value="Women's">Out of stock</option>
                </select>
                  </div>
                  <div className="col">
                    <p className="pt-3">Brand Name</p>
                ...
                <select id="list">
                  <option value="Parent category">--Select Size</option>
                  ...
                  <div className="col">
                    <p className="pt-3">Colors</p>
                <select id="list">
                  <option value="Parent category">--Select Colors</option>
                ...
                <div className="pb-3 m-0 d-flex items-center"><span className="pe-3">Status : </span><input type="radio" name="radio" /><span className="px-2">Display</span><input type="radio" name="radio" /><span className="px-2">Hide</span></div>
