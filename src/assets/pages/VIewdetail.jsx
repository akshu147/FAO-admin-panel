            ...
            <main>
                                    ...
                                    <Accordion.Item eventKey="0">
                                        ...
                                        <Accordion.Body>
                                            <ul className="p-0">
                                                ...
                                                <li> <i><VscCircleSmall /></i><Link to="/admin-panel/size/viewdetail" className="text-decoration-none text-white">View size</Link></li>
                                            </ul>
                ...
                <div className="right" style={{ width: mywidth.secondwidth }}>
                    ...
                    <div className="deshboard-navigation flex">
                        <Link to="/admin-panel/deshboard" className="text-decoration-none"><span>Home</span></Link> / <span>View size</span>
                    </div>
