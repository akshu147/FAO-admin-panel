      ...
      <main>
        <div className="left" style={{ width: mywidth.firstwidth, visibility: mywidth.status }}>
          ...
          <divhh>
            <ul className='p-0'>
              ...
              <li className="border my-1 mx-2 border"><i className="px-2"><MdBorderColor /></i><span><Link to="/admin-panel/orders" className="text-decoration-none text-white">Orders</Link></span> </li>
              <li className="p-0 my-1 mx-2">
                <Accordion>
                  <Accordion.Item eventKey="0">
        ...
        <div className="right" style={{ width: mywidth.secondwidth }}>
          ...
          <div className="deshboard-navigation flex">
            <Link to="/admin-panel/deshboard" className="text-decoration-none"><span>Home</span></Link> / <span>Story</span>
          </div>
          <div className="commen-div">
            ...
            <form action="">
              <div className="commencontent">
                <form>
                  <label className="pb-4 m-0">Story name</label>
                  <input type="text" placeholder="Story name" />
                  <label className="py-3 m-0">Image</label>
                  <input type="file" placeholder="category image" />
                  <label className="py-3 m-0">Burner Image</label>
                  <input type="file" placeholder="category image" />
